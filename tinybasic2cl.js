...
var _result = `(format *standard-output* "~a~%" (list ${exprList}))\n`;
...
var _result = `${stringOrExpression}`;
_ruleExit ("CommaExpr");
return _result;
},
